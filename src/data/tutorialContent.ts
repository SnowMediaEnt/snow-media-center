...
export const TUTORIAL_CHAPTERS: TutorialChapter[] = [
  ...
  },
  {
    ...
    slides: [
      ...
      { icon: Play, title: 'Rest on a channel and it plays in the preview box. OK goes full screen.', line2: 'In Vibez, OK plays right away. While watching, OK shows the controls; Up and Down change the channel.', art: { screen: 'controls', highlight: 'bar' } },
