...
export const TUTORIAL_CHAPTERS: TutorialChapter[] = [
  ...
  },
  {
    ...
    slides: [
      ...
      { icon: Play, title: 'OK on a channel previews it. OK again goes full screen.', line2: 'In Grid, OK plays right away. While watching, OK shows the controls; Up and Down change the channel.', art: { screen: 'controls', highlight: 'bar' } },
  ...
  },
  {
    ...
    slides: [
      ...
      { icon: Search, title: 'The menu down the left: Home, your libraries, Search, Request.', line2: 'OK on a poster opens the title page — then press Play.', art: { screen: 'plex-grid', highlight: 'grid' } },
