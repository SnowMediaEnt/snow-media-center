...
ALTER TABLE public.tenant_branding
  ...
  ADD COLUMN IF NOT EXISTS background_manifest_url text;
...
BEGIN
  ...
  INSERT INTO public.tenant_branding (
    ...
    background_image_url, background_manifest_url
  ) VALUES (
...
SET app_display_name = 'Canvas by Snow Media'
WHERE tenant_id = (SELECT id FROM public.tenants WHERE code = 'canvas');
