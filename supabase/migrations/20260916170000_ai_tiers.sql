...
INSERT INTO public.ai_tiers (feature, tier, model, gems, label, blurb, sort) VALUES
  ...
  ('chat',  'premium', 'gpt-5.4',                      0.20, 'Snow AI Premium', 'Sharper, deeper answers from the top model',        1),
  ('image', 'free',    'google/gemini-2.5-flash-image', 1.00, 'Standard',        'Good backgrounds in seconds',                      0),
  ('image', 'premium', 'gpt-image-1',                  3.00, 'Premium',         'Photoreal detail from the best image model',       1)
