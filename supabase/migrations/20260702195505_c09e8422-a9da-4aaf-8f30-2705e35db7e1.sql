...
DROP TRIGGER IF EXISTS trg_app_alerts_telegram_notify ON public.app_alerts;
CREATE TRIGGER trg_app_alerts_telegram_notify
AFTER INSERT ON public.app_alerts
FOR EACH ROW
EXECUTE FUNCTION public.notify_telegram_on_app_alert();