...
|---|------|------|--------|------|
| 1 | Plex buffers at 1080p/4K (Plex app fine on same box) — see bugs/plex-buffering.md | bug | building | 2 |
| 2 | Plex "Playback stats" panel (like the Plex app's stats) | feature | building | |
